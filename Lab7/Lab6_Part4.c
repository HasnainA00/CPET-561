...
volatile uint8*  key1_ptr              = (uint8*)KEY1_BASE;
...
uint32 RampPattern   = 0x12345678; //305419896 in decimal
uint32 testData32Bit = 0xABCDEF90; //2882400144 in decimal
uint16 testData16Bit = 0x1234;     //4660 in decimal
uint8 testData8Bit  = 0x00;		   //0 in decimal
